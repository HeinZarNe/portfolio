...
const Button = () => {
  ...
  return (
    <div
      className="Button rounded-3  position-absolute top-0 left-0"
      onClick={(_) => navigate("/")}
      style={{
  ...
  return (
    <>
      <div className="Contact Contact2">
        <div className="upper-inner-div p-5 d-flex flex-column justify-content-between align-items-start">
